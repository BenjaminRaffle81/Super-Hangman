  ...
  startGame: function() {
    ...
    inquirer.prompt([{
      ...
      if(answer.play){
        ...
        console.log("Fine, screw you. Get outta here, clown!");
      }
    })},
      ...
      var guessedAlready = false;
        ...
        if(guessedAlready === false){
          ...
          if(that.guessesRemaining > 0 && that.currentWord.wordFound === false) {
            ...
            console.log("You've already used that letter, bozo. Guess again, genius.")
            that.keepPromptingUser();
          }
    });
  }
